return {
    ...
    },
    {
        ...
        opts = {
            ...
            global = {
                ...
                pickers    = {
                    ...
                    { 'lsp_workspace_symbols', desc = "Symbols", prefix = '@', opts = { no_autoclose = true } },
        ...
        config = function(_, opts)
            ...
            vim.keymap.set('n', '<leader>sf', function() fzf.global({ query = "/" }) end, { desc = '[S]earch [F]iles', })
            vim.keymap.set('n', '<leader>sw', function() fzf.global({ query = "@" }) end,
